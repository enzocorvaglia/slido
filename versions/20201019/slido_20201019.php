...
include "template-tipo-rai.php";
include "slido-rai-style.php";	
...
/***************************************************************************************/
		...
		// The Query
			...
			$totale_loghi = $query->found_posts;
			...
			if ( $query->have_posts() ) {
				while ( $query->have_posts() ) {
					...
					if ($post_corrente % ($colonne*$righe) == 1 && $post_corrente < $totale_loghi){
						echo '</div>';	
						$gruppo++;
					}							
				}
